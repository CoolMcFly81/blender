...
#define SCE_PASS_LIGHT_GROUP_1            (((uint64_t) 1) << 43)
#define SCE_PASS_LIGHT_GROUP_2            (((uint64_t) 1) << 44)
#define SCE_PASS_LIGHT_GROUP_3            (((uint64_t) 1) << 45)
#define SCE_PASS_LIGHT_GROUP_4            (((uint64_t) 1) << 46)
#define SCE_PASS_LIGHT_GROUP_5            (((uint64_t) 1) << 47)
#define SCE_PASS_LIGHT_GROUP_6            (((uint64_t) 1) << 48)
#define SCE_PASS_LIGHT_GROUP_7            (((uint64_t) 1) << 49)
#define SCE_PASS_LIGHT_GROUP_8            (((uint64_t) 1) << 50)
